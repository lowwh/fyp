            ...
            <div class="row mb-2">
                <div class="col-sm-20">
                    <ol class="breadcrumb float-sm-left">
                        <li class="breadcrumb-item active"><i class="fas fa-home nav-icon"></i>
                            Home</li>
                    </ol>
                </div>
            </div>
                        ...
                        <div class="card"
                            ...
                            <div class="card-body d-flex justify-content-between flex-column">
                                <div style="margin-bottom: 10px;">
                                    ...
                                    @endif
                                    <div style="margin-bottom: 10px; f-top:10px; margin-top:10px">
                                ...
                                <div class="ml-auto"
                                    style="align-self: flex-end; background-color: #f0f8ff; padding: 5px; border-radius: 5px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); margin-bottom:10px">
