                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs" id="profileTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="project-tab" data-bs-toggle="tab" href="#project" role="tab"
                                aria-controls="project" aria-selected="false">Service</a>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content mt-3" id="profileTabContent">
                        ...
                        <div class="tab-pane fade" id="project" role="tabpanel" aria-labelledby="project-tab">
                            <h3 class="col-md-4 col-form-label text-bold">Services:</h3>
                            <ul>
                                @foreach ($user as $record)
                                    @if ($record->service_id)
                                        <div>
                                            <strong>Service ID:</strong> {{ $record->service_id }}<br>
